...
public class CustomerController {
    ...
    @Autowired //injecao de dependencia - controlador tem acesso a todos metodos da classe CustomerService
...
//        CustomerResponse customerResponse = CustomerConvert.toResponse(savedCustomer);
