...
public class TypeService {
    ...
    public Type updateType(Integer id, TypeRequest typeRequest) {
        ...
        existingType.setNomeServico(typeRequest.getNomeServico());
        existingType.setDescricaoServico(typeRequest.getDescricaoServico());
        existingType.setPrecoServico(typeRequest.getPrecoServico());
